Feature: Gestión de cursos, docentes y estudiantes con RBAC
  ...
  Scenario: Coordinador crea un curso y asigna un docente
    ...
    When crea un nuevo curso y asigna al docente "Ana León" como responsable
    Then el curso queda visible para el docente "Ana León"
  ...
  Scenario: Error al asignar un rol inexistente
    Given un "Coordinador académico" intenta asignar el rol "SuperAdmin" a un docente
